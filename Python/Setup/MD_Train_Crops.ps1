param ([string]$externalImagePath = "Z:\\alternative_footage\\CLEANED",
       [string]$mdOutputPath = "C:\Users\ollyp\Desktop\Project\Data")
...
$defaultImagePath =  "Z:\\alternative_footage\\CLEANED"
...
if ($null -ne $mdModel) {
    ...
    if (Test-Path -Path $downloadScript) {
        ...
        pyTorch model the md_v5a.0.0.pt, and put it in a folder of your choosing under the project folder."
    }  
}

conda deactivate
conda activate $condaEnvName
python $mdScriptPath $mdModel $imagesPath $mdOutputPath --recursive --output_relative_filenames --quiet  #--use_image_queue --checkpoint_frequency 5000
conda deactivate
